...
HRESULT CNormal_VillageF0::Ready_PartObjects()
{
    ...
    if (FAILED(__super::Add_PartObject(TEXT("Part_Body_VillageF0"), LEVEL_GAMEPLAY, TEXT("Prototype_GameObject_Normal_VillageF0_Body"), &BodyDesc)))
        return E_FAIL;
...
void CNormal_VillageF0::RootAnimation()
{
    /* 루트 모션 애니메션 코드 */
...
void CNormal_VillageF0::RotateDegree_To_Player()
{
...
void CNormal_VillageF0::OnCollisionEnter(CGameObject* _pOther)
{
}

void CNormal_VillageF0::OnCollision(CGameObject* _pOther)
{
}

void CNormal_VillageF0::OnCollisionExit(CGameObject* _pOther)
{
}
...
void CNormal_VillageF0::Walk_State::State_Enter(CNormal_VillageF0* pObject)
{
...
void CNormal_VillageF0::Walk_State::State_Update(_float fTimeDelta, CNormal_VillageF0* pObject)
{
...
void CNormal_VillageF0::Walk_State::State_Exit(CNormal_VillageF0* pObject)
{
}
