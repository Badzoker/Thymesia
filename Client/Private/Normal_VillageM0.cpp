...
void CNormal_VillageM0::OnCollisionEnter(CGameObject* _pOther)
{
}

void CNormal_VillageM0::OnCollision(CGameObject* _pOther)
{
}

void CNormal_VillageM0::OnCollisionExit(CGameObject* _pOther)
{
}
