...
void CNormal_VillageF1::OnCollisionEnter(CGameObject* _pOther)
{
}

void CNormal_VillageF1::OnCollision(CGameObject* _pOther)
{
}

void CNormal_VillageF1::OnCollisionExit(CGameObject* _pOther)
{
}
