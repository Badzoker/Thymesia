...
CLoader_Fortress::CLoader_Fortress(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLoader{ pDevice, pContext }
{
}

_uint APIENTRY Thread_Main_Fortress(void* pArg)
{
	CLoader_Fortress*		pLoader_Fortress = static_cast<CLoader_Fortress*>(pArg);

	pLoader_Fortress->Start_Loading();

	return 0;
}

HRESULT CLoader_Fortress::Initialize(LEVELID eNextLevelID)
{
...
HRESULT CLoader_Fortress::Start_Loading()
{
...
HRESULT CLoader_Fortress::Loading_For_Level_Fortress()
{
...
#pragma region 지형
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Terrain"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Terrain/T_Terrain_%d.dds"), 2))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Terrain_Normal"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Terrain/T_Terrain_Nor_%d.dds"), 2))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Terrain_ORM"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Terrain/T_Terrain_ORM_%d.dds"), 2))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_TerrainMask"),
	...
	//if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_VIBuffer_Terrain")
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Terrain"),	
...
#pragma region Sky
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Sky"),
		CSky::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	/* For.Prototype_Component_Texture_Sky */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Sky"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/SkyBox/Thymesia_SkyBox.dds"), 1))))
		return E_FAIL;

	
	/* For.Prototype_Component_VIBuffer_Cube */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_VIBuffer_Cube"),
...
#pragma region 카메라 
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Camera_Free"),
		CCamera_Free::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Camera_Debug"),	
...
#pragma endregion 
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_VIBuffer_Rect"),
...
#pragma region 셰이더
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxCube"),
		CShader::Create(m_pDevice, m_pContext, TEXT("../Bin/ShaderFiles/Shader_VtxCube.hlsl"), VTXCUBE::Elements, VTXCUBE::iNumElements))))
		return E_FAIL;


	/* For.Prototype_Component_Shader_VtxNorTex */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxNorTex"),
		CShader::Create(m_pDevice, m_pContext, TEXT("../Bin/ShaderFiles/Shader_VtxNorTex.hlsl"), VTXNORTEX::Elements, VTXNORTEX::iNumElements))))
		return E_FAIL;

	/* For.Prototype_Component_Shader_VtxMesh */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxMesh"),
		CShader::Create(m_pDevice, m_pContext, TEXT("../Bin/ShaderFiles/Shader_VtxMesh.hlsl"), VTXMESH::Elements, VTXMESH::iNumElements))))
		return E_FAIL;

	/* For.Prototype_Component_Shader_VtxInstanceMesh */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxInstanceMesh"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxMeshNoDefferd"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxAnimMesh"),
		CShader::Create(m_pDevice, m_pContext, TEXT("../Bin/ShaderFiles/Shader_VtxAnimMesh.hlsl"), VTXANIMMESH::Elements, VTXANIMMESH::iNumElements))))
		return E_FAIL;

	/* For.Prototype_Component_Shader_VtxAnimMeshNoDefferd */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxAnimMeshNoDefferd"),	
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxPosTex"),
		CShader::Create(m_pDevice, m_pContext, TEXT("../Bin/ShaderFiles/Shader_VtxPosTex.hlsl"), VTXPOSTEX::Elements, VTXPOSTEX::iNumElements))))
		return E_FAIL;

	/* For.Prototype_Component_Shader_VtxPosTexInstance */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxPosTexInstance"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxPointInstance"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Shader_VtxPosTex_UI"),
...
#pragma region Navigation 
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Navigation"),
...
#pragma region Collider
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Collider_AABB"),
		CCollider::Create(m_pDevice, m_pContext,CCollider::TYPE_AABB))))	
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Collider_SPHERE"),
...
#pragma region UI 텍스쳐
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_UI_InteractionButton"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/ThymesiaUI/General/UI_InteractableIndicator.dds"), 1))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_InteractionButton"),
...
#pragma region 티메시아 캐릭터 
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Corner"),
		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/Corvus/Corvus.fbx", CModel::MODEL_ANIM, PreTransformMatrix))))
		return E_FAIL;

	///* For.Prototype_GameObject_Body_Player */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Body_Player"),
		CBody_Player::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	///* For.Prototype_GameObject_Player */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Player"),
...
#pragma region 티메시아 캐릭터 오른손 무기 모델 
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Corvus_Right_Weapon"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Right_Weapon"),
...
#pragma region 티메시아 캐릭터 왼손 무기 모델 
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Corvus_Left_Weapon"),
		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/Corvus_Left_Weapon/Corvus_Left_Weapon.fbx", CModel::MODEL_NONANIM))))
		return E_FAIL;


	///* For.Prototype_GameObject_Weapon */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Left_Weapon"),
...
#pragma region 티메시아 손톱 갈퀴 공격 
	///* For.Prototype_GameObject_Weapon */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Right_Claw"),
...
#pragma region 티메시아 카메라 
	///* For.Prototype_GameObject_Weapon */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_PlayerCamera"),
...
#pragma region Objects
	...
	//P_Rag03
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Rag03"),
	...
	//SM_WoodFence03
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_WoodFence03"),
	...
	//SM_WoodFence04
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_WoodFence04"),
	...
	//SM_WoodStairs03
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_WoodStairs03"),
	...
	//SM_WoodStairs03
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_HORSE_P_WoodenFrame02_05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossAtriumCircle01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossCemetery_02_02"),
	...
	//P_BossCemetery_04
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossCemetery_04"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossCemetery_05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossCemetery_06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossInteriorArches02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_ChurchWindowGrilles01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_LongStairs01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Plains_CastleArch_Ruin_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Trim_01a"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Wall_8x8_Broken_01c"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Wall_8x8_Broken_01d"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Wall_8x8_Broken_01e"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing_base01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing_pillar01_2"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing01_3"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Brick_stone_stairs_1_a"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Gate_17d"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_ground_Road_Middle_250x250cm_1_a"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_T_P_BossRoomVines01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossArtriumCircleRailing_Down02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossArtriumCircleRailing_Down03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossArtriumCircleRailing_Down04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossAtriumCircleRailing_Top01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossAtriumCircleRailing_Up01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossAtriumCircleRailing_Up02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossAtriumCircleRailing_Up04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BossAtriumCircleRailing_Up03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing03_1"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Fortress_BossDoor_Left01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Fortress_BossDoor_Right01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Debris_01a"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Debris_02a"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Scafold_01b"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Scafold_01c"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_14"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_16"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_13"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_CemeteryStairs01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Brick_Floor"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Archive_Chair01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Ladder"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BaseWall_01_Corner"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BaseWall_02_Plain"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_LogPile_03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Separator"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_crypt_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_crypt_05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_crypt_06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_crypt_08"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_crypt_09"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_01"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_03"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_05"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_06"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_07"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_08"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_curb_09"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth07"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Cloth08"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_rock_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_rock_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_rock_03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_CemeteryStairs02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_CemeteryStairs03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Stairs"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Stairs02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_urn_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_urn_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_urn_03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_urn_04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_urn_05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_urn_06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_urn_09"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_07"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_08"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_09"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_10"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_12"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_15"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_19"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_20"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_21"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_22"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_23"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_24"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_25"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_26"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_27"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_29"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_30"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_31"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_32"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_33"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_34"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_fence_35"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Barrel_Closed"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_07"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_08"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_09"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_10"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_11"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_12"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_13"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_15"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_16"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_17"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_18"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_20"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_21"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_22"),
		...
		return E_FAIL
		;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_23"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_25"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_26"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_27"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_28"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_29"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_31"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_32"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_33"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_34"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_35"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_36"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_37"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_38"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_41"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_42"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_44"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_46"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_48"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_50"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_51"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_53"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_54"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_55"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_56"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_60"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_61"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_62"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_gravestone_63"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Wall_Combined_03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Deceased01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Deceased02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Deceased03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Deceased04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Deceased05"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Deceased06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_DeadTree_01a"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_DeadTree_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree001"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree002"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree003"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree004"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree005"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree006"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree006_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_BigTree006_03_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_TreeAerialRoot01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_TreeAerialRoot02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BrokenTree01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_DeadTree02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_DeadTree03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_DryTreeT3_2_SM_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_DryTreeT3_branches_1_SM"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_DryTreeT3_branches_1_SM_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_DryTreeT3_branches_3_SM"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_DryTreeT3_branches_5_SM"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_08"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_10"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_11"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_14"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_15"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_16"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_19"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_20"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_28"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_35"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_36"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_38"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_39"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_40"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_41"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_tombstone_42"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing_base02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing_base07"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing_base08"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing02_1"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing07_1"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing08_1"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing08_2"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_RailingDamage01_1"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_RailingDamage01_3"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_RailingDamage02_1"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_RailingDamage05_1"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Railing06"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_RailingDamage07"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_RailingPillarDamage01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Planks"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Railing"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_Tower"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_chandelier04"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_CircusBalloon01"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_CircusBalloon02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_CircusballoonDamage01"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_CircusballoonDamage02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_VariationBranch01_01"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_VariationBranch02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_VariationBranch03"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_HORSE_P_WoodenStand02"),
		...
		return E_FAIL;;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BloodTent02"),
		...
		return E_FAIL;;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_BloodWoodChair01"),
		...
		return E_FAIL;;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Boss_Floor01"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Boss_Floor02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_WoodenChair01"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Cross"),
		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/Objects/Cross/Cross.fbx", CModel::MODEL_NONANIM, PreTransformMatrix))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Hang01"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Hang01_02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Hang01_03"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Hang02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Hang02_02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Hang03"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_Hang03_02"),
		...
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_P_HempRope"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_tree01_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_tree01_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_tree02_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_tree02_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_tree03_01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_tree03_02"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Greenhouse_Elevator01"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_SM_WoodStair03"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_candle01_fire"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Object_StaticObject"),
		CStaticObject::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Object_BillBoardObject"),
...
#pragma region  인스턴싱용 환경 오브젝트
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Grass0"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Tree0"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_House0"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_House3"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Object_GroundObject"),
...
#pragma region 트리거 오브젝트
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_TriggerObject"),
		CTriggerObject::Create(m_pDevice, m_pContext))))
		return E_FAIL;
#pragma endregion

//#pragma region 아이템 
//	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Sphere"),
//		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/Item/Item0/Sphere.fbx", CModel::MODEL_NONANIM, PreTransformMatrix))))
//		return E_FAIL;
//
//	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_GameItem"), CGameItem::Create(m_pDevice, m_pContext))))
//		return E_FAIL;
//#pragma endregion
...
#pragma region 테스트용 사다리
	...
	//if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Ladder"),
...
#pragma region 티메시아 보스
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Boss_Magician_Body"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Boss_Magician_Sword"),
	...
	PreTransformMatrix = /*XMMatrixScaling(0.002f, 0.002f, 0.002f) **/ XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Boss_Magician_Cane"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Boss_Magician_Body"),
		CBody_Magician::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Boss_Magician_Sword"),
		CWeapon_Magician_Sword::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Boss_Magician_Cane"),
		CWeapon_Cane::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Boss_Magician"),
		CBoss_Magician::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	PreTransformMatrix = /*XMMatrixScaling(0.002f, 0.002f, 0.002f) **/ XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Boss_Varg_Body"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Boss_Varg_Body"),
		CBody_Varg::Create(m_pDevice, m_pContext))))
		return E_FAIL;
	PreTransformMatrix = /*XMMatrixScaling(0.002f, 0.002f, 0.002f) **/ XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Boss_Varg_Knife"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Boss_Varg_Knife"),
		CVargKnife::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Boss_Varg"),
		CBoss_Varg::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	//보스 HP바

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Boss_HP"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/ThymesiaUI/Boss_HP/BossHP%d.png"), 5))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_UI_Boss_HP_Bar"),
		CUI_Boss_HP_Bar::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_UI_Boss_HP_Bar_Gage"),
		CUI_Boss_HP_Bar_Gage::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_UI_Boss_HP_Bar_Gage_Effect"),
		CUI_Boss_HP_Bar_Gage_Effect::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_UI_Boss_HP_Phase"),
...
#pragma region 엘리트 몬스터
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Elite_Joker_Body"),
	...
	PreTransformMatrix = /*XMMatrixScaling(0.002f, 0.002f, 0.002f) **/ XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Elite_Joker_Weapon"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Elite_Joker_Body"),
		CBody_Joker::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Elite_Joker_Weapon"),
		CJoker_Weapon::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Elite_Joker"),
		CElite_Joker::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Elite_HArmorLV2_Body"),
	...
	PreTransformMatrix = /*XMMatrixScaling(0.002f, 0.002f, 0.002f) **/ XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Weapon_GreatSword"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Elite_HArmorLV2_Body"),
		CBody_HArmorLV2::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Weapon_GreatSword"),
		CWeapon_GreatSword::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Elite_HArmorLV2"),
...
#pragma region 일반 몬스터
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Normal_VillageM0_Body"),
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Normal_VillageM1_Body"),
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Normal_VillageF0_Body"),
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Normal_VillageF1_Body"),
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Weapon_Axe"),
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Weapon_Dagger"),
	...
	PreTransformMatrix = XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_Weapon_Shield"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageM0_Body"),
		CBody_VillageM0::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageM1_Body"),
		CBody_VillageM1::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageF0_Body"),
		CBody_VillageF0::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageF1_Body"),
		CBody_VillageF1::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	//몬스터 Weapon

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Weapon_Axe"),
		CWeapon_Axe::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Weapon_Dagger"),
		CWeapon_Dagger::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Weapon_Shield"),
		CWeapon_Shield::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	//몬스터 객체

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageM0"),
		CNormal_VillageM0::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageM1"),
		CNormal_VillageM1::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageF0"),
		CNormal_VillageF0::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Normal_VillageF1"),
		CNormal_VillageF1::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	//몬스터 HP바
	/* For.Prototype_Component_Texture_Monster_HP*/
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Monster_HP"),
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Monster_HP_Bar"),
		CMonster_HP_Bar::Create(m_pDevice, m_pContext))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Monster_HP_Gage"),
		CMonster_HP_Gage::Create(m_pDevice, m_pContext))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Monster_HP_Gage_Effect"),
		CMonster_HP_Gage_Effect::Create(m_pDevice, m_pContext))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Monster_HP_Bar_Effect"),
		CMonster_HP_Bar_Effect::Create(m_pDevice, m_pContext))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_Monster_Locked_On"),
		CLocked_On::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	//몬스터용 노이즈 텍스쳐 /* For.Prototype_Component_Texture_Effect_Mesh_Noise*/
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Monster_Noise"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effect/Mesh_Noise/texNoise6.dds"), 1))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Texture_Monster_Locked_On"),
...
#pragma region NPC
	...
	PreTransformMatrix = /*XMMatrixScaling(0.002f, 0.002f, 0.002f) **/ XMMatrixRotationY(XMConvertToRadians(180.f));
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_Component_Model_NPC_Aisemy_Body"),
		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/NPC/NPC_Aisemy.fbx", CModel::MODEL_ANIM, PreTransformMatrix))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_NPC_Aisemy"),
		CAisemy::Create(m_pDevice, m_pContext))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_FORTRESS, TEXT("Prototype_GameObject_NPC_Aisemy_Body"),
...
CLoader_Fortress * CLoader_Fortress::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, LEVELID eNextLevelID)
{
	CLoader_Fortress*	pInstance = new CLoader_Fortress(pDevice, pContext);

	if (FAILED(pInstance->Initialize(eNextLevelID)))
	{
		MSG_BOX("Failed To Created : CLoader_Fortress");
