...
#pragma region UI 텍스쳐
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Texture_UI_LevelImage"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/ThymesiaUI/General/UI_LevelImage_%d.dds"), 4))))
		return E_FAIL;
...
#pragma region Effect_Particle
	...
	/* For.Prototype_Component_VIBuffer_Point_Compute_DustDelay_Mutation_Intro */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_DustDelay_Mutation_Intro"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_DustDelay_Mutatin_Intro_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Scythe_1 */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Scythe_1"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_PlayerScythe_1_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Scythe_2 */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Scythe_2"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_PlayerScythe_2_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Halberd_1 */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Halberd_1"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_PlayerHalberd_1_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Halberd_2 */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Scythe_Player_Halberd_2"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_PlayerHalberd_2_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Hurricane_Heal */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Hurricane_Heal"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Hurricane_Heal_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get"),
	...
	/* For.Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get_Red */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get_Red"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Hurricane_Item_Get_Red_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get_Blue */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get_Blue"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Hurricane_Item_Get_Blue_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get_Yellow */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Hurricane_Item_Get_Yellow"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Hurricane_Item_Get_Yellow_Buffer.dat")))))
		return E_FAIL;
	...
	/* For.Prototype_Component_VIBuffer_Point_Compute_Spark_PlayerAxe */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Spark_PlayerAxe"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_PlayerAxe_1_Spark_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Dust_PlayerAxe */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Dust_PlayerAxe"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_PlayerAxe_1_Dust_Buffer.dat")))))
		return E_FAIL;
	...
	/* For.Prototype_Component_VIBuffer_Point_Compute_World_Skill_GreatSword_Start */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_Skill_GreatSword_Start"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_World_Skill_GreatSword_Start_Buffer.dat")))))
		return E_FAIL;
	...
	/* For.Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_World_ChargeClaw_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Hit */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Hit"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_World_ChargeClaw_Hit_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Hit_Steal */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Hit_Steal"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_World_ChargeClaw_Hit_Steal_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Hit_StealComplete */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Hit_StealComplete"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_World_ChargeClaw_Hit_Steal_Complete_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Ready */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Ready"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_World_ChargeClaw_Ready_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Loop */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_ChargeClaw_Loop"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_World_ChargeClaw_Loop_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Dust_Player_Varg_SpAttack */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Dust_Player_Varg_SpAttack"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Dust_Player_Varg_SpAttack_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Blood_Player_Varg_SpAttack */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Blood_Player_Varg_SpAttack"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Blood_Player_Varg_SpAttack_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Spark_Player_Varg_SpAttack */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Spark_Player_Varg_SpAttack"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Spark_Player_Varg_SpAttack_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Dust_Player_Varg_SpAttack_Hit */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Dust_Player_Varg_SpAttack_Hit"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Dust_Player_Varg_SpAttack_Hit_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_Dust_Spore */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_Dust_Spore"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_Dust_Spore_Buffer.dat")))))
		return E_FAIL;

	/* For.Prototype_Component_VIBuffer_Point_Compute_World_Continue_Gas_Spore */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Point_Compute_World_Continue_Gas_Spore"),
		CVIBuffer_Point_Compute::Create(m_pDevice, m_pContext, TEXT("../Bin/DataFiles/Effect/Particle/ParticleEffect_WorldGas_Spore_Buffer.dat")))))
		return E_FAIL;
